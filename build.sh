...
rpm-ostree install java-latest-openjdk dotnet-sdk-8.0 dotnet-sdk-9.0 dotnet-sdk-10.0 nodejs wivrn wivrn-dashboard rust-openxr-devel rust-openxr-sys-devel
